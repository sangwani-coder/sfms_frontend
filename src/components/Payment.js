...
const Account = () => {
  ...
  const handleSubmit = (event) => {
    ...
    var config = {
      ...
      headers: {
        ...
        Cookie:
          "csrftoken=srORLevgm5wspjFS8eo4bMB48xQMU3biNZQ6hPp8LCOEgkL8Q2zp3kOHPRIjnzoa; sessionid=ayw57xsbo8httx6zpjf2pha5i4alq9pv"
      },
      data: data
    };
  ...
  return (
    <div className="container-lg">
      {paid === true && (
        <p className="d-flex justify-content-center p-3 mb-2 bg-success text-white">
          Payment Sent Succesfully
        </p>
      )}
      {errors === true && (
        <p className="p-3 mb-2 bg-warning text-dark">Payment Failed!</p>
      )}
      ...
      <h2 className="d-flex justify-content-center text-info">
        Enter Amount and Account Number
      </h2>
      <br />
